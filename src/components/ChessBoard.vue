...
const boardUrl = computed(() => {
  ...
  const boardExt = ['blue', 'brown', 'green', 'green-plastic', 'purple'].includes(boardImg) ? 'png' : 'jpg';
...
watch(() => [props.pieceSet, props.boardTheme], () => {
...
<style>
/* Global Piece Styles */
.cg-wrap piece.pawn.white { background-image: var(--pawn-white); }
.cg-wrap piece.pawn.black { background-image: var(--pawn-black); }
.cg-wrap piece.knight.white { background-image: var(--knight-white); }
.cg-wrap piece.knight.black { background-image: var(--knight-black); }
.cg-wrap piece.bishop.white { background-image: var(--bishop-white); }
.cg-wrap piece.bishop.black { background-image: var(--bishop-black); }
.cg-wrap piece.rook.white { background-image: var(--rook-white); }
.cg-wrap piece.rook.black { background-image: var(--rook-black); }
.cg-wrap piece.queen.white { background-image: var(--queen-white); }
.cg-wrap piece.queen.black { background-image: var(--queen-black); }
.cg-wrap piece.king.white { background-image: var(--king-white); }
.cg-wrap piece.king.black { background-image: var(--king-black); }
</style>
